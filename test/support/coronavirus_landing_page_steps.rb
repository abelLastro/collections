...
module CoronavirusLandingPageSteps
  ...
  def then_i_can_see_the_timeline
    ...
    assert page.has_selector?("#covid-timeline h3", text: "18 September")
    ...
    assert page.has_selector?("#covid-timeline h3", text: "15 September")
    ...
    assert page.has_selector?("#covid-timeline h3", text: "14 September")
    ...
    assert page.has_selector?("#covid-timeline h3", text: "24 July")
